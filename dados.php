...
<div class="well well-sm col-xs-9 text-center col-xs-offset-1"><?php 
 ...
 <div class="well well-sm col-xs-9 text-center col-xs-offset-1">
 	<div class="row col-xd-6">Acumulado CPU
	<?php 
		$acumuladocpu = $d1 + $d2;
		$totalcpu = $acumuladocpu + $d1 + $d2;
		echo $totalcpu;
	 ?>
 	</div>
 	<div class="row col-xd-6">Acumulado YO
	<?php 
		$acumuladoyo = $d3 + $d4;
		$totalyo = $acumuladoyo + $d3 + $d4;
		echo $totalyo;
	 ?>
 	</div>
